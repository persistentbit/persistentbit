package com.persistentbit.sql.dsl.generic.expressions.impl.old.dtuples;

import com.persistentbit.collections.PList;
import com.persistentbit.sql.dsl.exprcontext.DbSqlContext;
import com.persistentbit.sql.dsl.generic.expressions.DExpr;
import com.persistentbit.sql.dsl.generic.expressions.ETuple6;
 ...
 * @since 1/12/17
 */
public class DTuple6<T1,T2,T3,T4,T5,T6> implements DImpl<Tuple6<T1,T2,T3,T4,T5,T6>> , ETuple6<T1,T2,T3,T4,T5,T6>{
