...
import com.persistentbit.sql.dsl.generic.expressions.impl.old.dtuples.DTuple3;
 ...
 * @since 1/12/17
 */
public interface ETuple2<E1 extends DExpr<J1>, E2 extends DExpr<J2>, J1, J2>
	extends DExpr<Tuple2<? extends J1, ? extends J2>>{
