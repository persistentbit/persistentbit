...
public class QueryCtx {
	...
	@Generated
	public QueryCtx(ExprContext context, PList<Table> from, @Nullable PList<JoinImpl> joins, @Nullable EBool where, @Nullable PList<OrderBy> orderBy, @Nullable Tuple2<Long,Long> limitAndOffset){
	...
	public QueryCtx(ExprContext context, PList<Table> from){
			this(context, from, null, null, null, null);
	}
	@Generated
	...
	static public class Builder<_T1, _T2> {
		...
		private	Tuple2<Long,Long>	limitAndOffset;
		...
		public  Builder<_T1, _T2>	setLimitAndOffset(@Nullable Tuple2<Long,Long> limitAndOffset){
			this.limitAndOffset	=	limitAndOffset;
			return this;
		}
	}
	...
	public  QueryCtx	withContext(ExprContext context){
		return new QueryCtx(context, from, joins, where, orderBy, limitAndOffset);
	}
	/**
	 ...
	 */
	@Generated
	public  Optional<Tuple2<Long,Long>>	getLimitAndOffset(){
	 ...
	 */
	@Generated
	public  QueryCtx	withLimitAndOffset(@Nullable Tuple2<Long,Long> limitAndOffset){
		return new QueryCtx(context, from, joins, where, orderBy, limitAndOffset);
	}
	@Generated
	@Override
	...
	public  QueryCtx	updated(Function<Builder,Builder> updater){
		...
		b = updater.apply(b);
		return new QueryCtx(b.context, b.from, b.joins, b.where, b.orderBy, b.limitAndOffset);
	}
	@Generated
	@SuppressWarnings("unchecked")
	...
	public  static Result<QueryCtx>	buildExc(ThrowingFunction<Builder<NOT,NOT>, Builder<SET,SET>,Exception> setter){
		return Result.noExceptions(() -> setter.apply(new Builder<>())).mapExc(b -> new QueryCtx(b.context, b.from, b.joins, b.where, b.orderBy, b.limitAndOffset));
	}
}
