package com.generated.tables;

import com.generated.expressions.EAddress;
import com.generated.expressions.EPersons;
import com.generated.impl.typefactories.PersonsTypeFactory;
import com.generated.inserts.InsertPersons;
...
public class TPersons extends AbstractTable<EPersons, Persons>{
	...
	private TPersons(ExprContext context, String alias) {
		super(context, alias);
		context.registerType(EPersons.class, PersonsTypeFactory.class);
		this._all = context
