...
public class Tuple5<T1, T2, T3, T4, T5> implements Comparable<Tuple5<T1, T2, T3, T4, T5>>, Serializable{
	...
	public Tuple5(@Nullable T1 _1, @Nullable T2 _2, @Nullable T3 _3, @Nullable T4 _4, @Nullable T5 _5) {
		this._1 = _1;
		this._2 = _2;
		this._3 = _3;
		this._4 = _4;
	...
	public <R> R map(Function<T1, Function<T2, Function<T3, Function<T4, Function<T5,R>>>>> map) {
		return map.apply(_1).apply(_2).apply(_3).apply(_4).apply(_5);
	}
