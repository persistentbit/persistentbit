...
FROM (((( CATEGORY
LEFT JOIN film_category ON (( CATEGORY.category_id = film_category.category_id))) LEFT JOIN film
ON ((film_category.film_id = film.film_id))) JOIN film_actor ON ((film.film_id = film_actor.film_id))) JOIN actor
...
CREATE VIEW sales_by_film_category AS
  ...
  FROM (((((payment p
    JOIN rental r ON ((p.rental_id = r.rental_id))) JOIN inventory i ON ((r.inventory_id = i.inventory_id))) JOIN film f
      ON ((i.film_id = f.film_id))) JOIN film_category fc ON ((f.film_id = fc.film_id))) JOIN category c
...
CREATE INDEX idx_fk_payment_p2007_01_customer_id
  ON payment_p2007_01 USING BTREE (customer_id);
...
CREATE INDEX idx_fk_payment_p2007_02_customer_id
  ON payment_p2007_02 USING BTREE (customer_id);

--
-- Name: idx_fk_payment_p2007_02_staff_id; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE INDEX idx_fk_payment_p2007_02_staff_id
  ON payment_p2007_02 USING BTREE (staff_id);
...
CREATE INDEX idx_fk_payment_p2007_03_customer_id
  ON payment_p2007_03 USING BTREE (customer_id);
...
CREATE INDEX idx_fk_payment_p2007_04_customer_id
  ON payment_p2007_04 USING BTREE (customer_id);
...
CREATE INDEX idx_fk_payment_p2007_04_staff_id
  ON payment_p2007_04 USING BTREE (staff_id);
...
CREATE INDEX idx_fk_payment_p2007_05_customer_id
  ON payment_p2007_05 USING BTREE (customer_id);
...
CREATE INDEX idx_fk_payment_p2007_05_staff_id
  ON payment_p2007_05 USING BTREE (staff_id);

--
-- Name: idx_fk_payment_p2007_06_customer_id; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE INDEX idx_fk_payment_p2007_06_customer_id
  ON payment_p2007_06 USING BTREE (customer_id);

--
-- Name: idx_fk_payment_p2007_06_staff_id; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE INDEX idx_fk_payment_p2007_06_staff_id
  ON payment_p2007_06 USING BTREE (staff_id);
...
CREATE RULE payment_insert_p2007_01 AS ON INSERT TO payment
  WHERE ((new.payment_date >= '2007-01-01 00:00:00' : :TIMESTAMP WITHOUT TIME ZONE) AND
         (new.payment_date < '2007-02-01 00:00:00' : :TIMESTAMP WITHOUT TIME
          ZONE)) DO INSTEAD INSERT INTO payment_p2007_01 (payment_id, customer_id, staff_id, rental_id, amount, payment_date)
...
CREATE RULE payment_insert_p2007_02 AS ON INSERT TO payment
  WHERE ((new.payment_date >= '2007-02-01 00:00:00' : :TIMESTAMP WITHOUT TIME ZONE) AND
         (new.payment_date < '2007-03-01 00:00:00' : :TIMESTAMP WITHOUT TIME
          ZONE)) DO INSTEAD INSERT INTO payment_p2007_02 (payment_id, customer_id, staff_id, rental_id, amount, payment_date)
VALUES (DEFAULT, new.customer_id, new.staff_id, new.rental_id, new.amount, new.payment_date);
...
CREATE RULE payment_insert_p2007_03 AS ON INSERT TO payment
  WHERE ((new.payment_date >= '2007-03-01 00:00:00' : :TIMESTAMP WITHOUT TIME ZONE) AND
         (new.payment_date < '2007-04-01 00:00:00' : :TIMESTAMP WITHOUT TIME
          ZONE)) DO INSTEAD INSERT INTO payment_p2007_03 (payment_id, customer_id, staff_id, rental_id, amount, payment_date)
VALUES (DEFAULT, new.customer_id, new.staff_id, new.rental_id, new.amount, new.payment_date);
...
CREATE RULE payment_insert_p2007_04 AS ON INSERT TO payment
  WHERE ((new.payment_date >= '2007-04-01 00:00:00' : :TIMESTAMP WITHOUT TIME ZONE) AND
         (new.payment_date < '2007-05-01 00:00:00' : :TIMESTAMP WITHOUT TIME
          ZONE)) DO INSTEAD INSERT INTO payment_p2007_04 (payment_id, customer_id, staff_id, rental_id, amount, payment_date)
VALUES (DEFAULT, new.customer_id, new.staff_id, new.rental_id, new.amount, new.payment_date);
...
CREATE RULE payment_insert_p2007_05 AS ON INSERT TO payment
  WHERE ((new.payment_date >= '2007-05-01 00:00:00' : :TIMESTAMP WITHOUT TIME ZONE) AND
         (new.payment_date < '2007-06-01 00:00:00' : :TIMESTAMP WITHOUT TIME
          ZONE)) DO INSTEAD INSERT INTO payment_p2007_05 (payment_id, customer_id, staff_id, rental_id, amount, payment_date)
VALUES (DEFAULT, new.customer_id, new.staff_id, new.rental_id, new.amount, new.payment_date);
...
CREATE RULE payment_insert_p2007_06 AS ON INSERT TO payment
  WHERE ((new.payment_date >= '2007-06-01 00:00:00' : :TIMESTAMP WITHOUT TIME ZONE) AND
         (new.payment_date < '2007-07-01 00:00:00' : :TIMESTAMP WITHOUT TIME
          ZONE)) DO INSTEAD INSERT INTO payment_p2007_06 (payment_id, customer_id, staff_id, rental_id, amount, payment_date)
VALUES (DEFAULT, new.customer_id, new.staff_id, new.rental_id, new.amount, new.payment_date);
