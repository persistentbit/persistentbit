...
public class TPersonTable extends DTable<Person, TPerson> {
	...
	public TPersonTable(DbTableContext context){
		super(context);
	...
	public  TPersonTable	withTableAlias(String tableAlias){
		return new TPersonTable(_tableContext.withTableAlias(tableAlias));
	}
	public  static TPersonTable	cast(DExpr<Person> expr){
		return (TPersonTable)expr;
	}
}
