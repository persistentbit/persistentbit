...
public class AuthUser {
	...
	@DbColumnName("auth_app_id")
	private  final	long	authAppId;
	@DbColumnName("user_name")
	private  final	String	userName;
	@DbColumnName("password")
	private  final	String	password;
	@DbColumnName("wrong_password_count")
	private  final	int	wrongPasswordCount;
	@Nullable
	@DbColumnName("created")
	private  final	LocalDateTime	created;
	@Nullable
	@DbColumnName("last_login")
	private  final	LocalDateTime	lastLogin;
	@Nullable
	@DbColumnName("verified")
	private  final	LocalDateTime	verified;
	@Nullable
	@DbColumnName("reset_password_code")
	private  final	String	resetPasswordCode;
	@Nullable
	@DbColumnName("reset_password_valid_until")
	private  final	LocalDateTime	resetPasswordValidUntil;
	@Nullable
	@DbColumnName("verify_code")
	private  final	String	verifyCode;
	@Nullable
	@DbColumnName("verify_code_valid_until")
	private  final	LocalDateTime	verifyCodeValidUntil;
	
	
	@Generated
	public AuthUser(long id, long authAppId, String userName, String password, int wrongPasswordCount, @Nullable LocalDateTime created, @Nullable LocalDateTime lastLogin, @Nullable LocalDateTime verified, @Nullable String resetPasswordCode, @Nullable LocalDateTime resetPasswordValidUntil, @Nullable String verifyCode, @Nullable LocalDateTime verifyCodeValidUntil){
	...
	static public class Builder<_T1, _T2, _T3, _T4, _T5> {
		...
		public  Builder<_T1, _T2, _T3, _T4, _T5>	setResetPasswordValidUntil(@Nullable LocalDateTime resetPasswordValidUntil){
			this.resetPasswordValidUntil	=	resetPasswordValidUntil;
			return this;
		}
	...
	public  boolean	equals(@Nullable Object o){
		...
		if(resetPasswordCode != null ? !resetPasswordCode.equals(obj.resetPasswordCode) : obj.resetPasswordCode!= null) return false;
		if(resetPasswordValidUntil != null ? !resetPasswordValidUntil.equals(obj.resetPasswordValidUntil) : obj.resetPasswordValidUntil!= null) return false;
		if(verifyCode != null ? !verifyCode.equals(obj.verifyCode) : obj.verifyCode!= null) return false;
		if(verifyCodeValidUntil != null ? !verifyCodeValidUntil.equals(obj.verifyCodeValidUntil) : obj.verifyCodeValidUntil!= null) return false;
		return true;
	}
	@Generated
	@Override
	...
	public  String	toString(){
		return "AuthUser[" + 
			...
			", lastLogin=" + lastLogin + 
			", verified=" + verified + 
			", resetPasswordCode=" + (resetPasswordCode == null ? "null" : '\"' + UString.present(UString.escapeToJavaString(resetPasswordCode),32,"...") + '\"') +
			", resetPasswordValidUntil=" + resetPasswordValidUntil + 
			", verifyCode=" + (verifyCode == null ? "null" : '\"' + UString.present(UString.escapeToJavaString(verifyCode),32,"...") + '\"') +
	...
	@Generated
	@SuppressWarnings("unchecked")
	public  static AuthUser	build(ThrowingFunction<Builder<NOT,NOT,NOT,NOT,NOT>, Builder<SET,SET,SET,SET,SET>, Exception> setter){
		Builder b = setter.toNonChecked().apply(new Builder());
		return new AuthUser(b.id, b.authAppId, b.userName, b.password, b.wrongPasswordCount, b.created, b.lastLogin, b.verified, b.resetPasswordCode, b.resetPasswordValidUntil, b.verifyCode, b.verifyCodeValidUntil);
	}
	@Generated
	@SuppressWarnings("unchecked")
	public  static Result<AuthUser>	buildExc(ThrowingFunction<Builder<NOT,NOT,NOT,NOT,NOT>, Builder<SET,SET,SET,SET,SET>,Exception> setter){
		return Result.noExceptions(() -> setter.apply(new Builder<>())).mapExc(b -> new AuthUser(b.id, b.authAppId, b.userName, b.password, b.wrongPasswordCount, b.created, b.lastLogin, b.verified, b.resetPasswordCode, b.resetPasswordValidUntil, b.verifyCode, b.verifyCodeValidUntil));
	}
}
