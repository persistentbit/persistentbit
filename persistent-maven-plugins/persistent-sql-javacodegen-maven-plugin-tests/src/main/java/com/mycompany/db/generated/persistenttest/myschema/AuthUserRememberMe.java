...
public class AuthUserRememberMe {
	...
	@DbColumnName("auth_user_id")
	private  final	long	authUserId;
	@DbColumnName("code")
	private  final	String	code;
	@DbColumnName("valid_until")
	private  final	LocalDateTime	validUntil;
	@DbColumnName("password_code")
	...
	public  String	toString(){
		return "AuthUserRememberMe[" + 
			...
			", code=" + (code == null ? "null" : '\"' + UString.present(UString.escapeToJavaString(code),32,"...") + '\"') +
			", validUntil=" + validUntil + 
			", passwordCode=" + (passwordCode == null ? "null" : '\"' + UString.present(UString.escapeToJavaString(passwordCode),32,"...") + '\"') +
			']';
	}
	@Generated
	...
	@Generated
	@SuppressWarnings("unchecked")
	public  static AuthUserRememberMe	build(ThrowingFunction<Builder<NOT,NOT,NOT,NOT,NOT>, Builder<SET,SET,SET,SET,SET>, Exception> setter){
		Builder b = setter.toNonChecked().apply(new Builder());
		return new AuthUserRememberMe(b.id, b.authUserId, b.code, b.validUntil, b.passwordCode);
	}
	@Generated
	@SuppressWarnings("unchecked")
	public  static Result<AuthUserRememberMe>	buildExc(ThrowingFunction<Builder<NOT,NOT,NOT,NOT,NOT>, Builder<SET,SET,SET,SET,SET>,Exception> setter){
		return Result.noExceptions(() -> setter.apply(new Builder<>())).mapExc(b -> new AuthUserRememberMe(b.id, b.authUserId, b.code, b.validUntil, b.passwordCode));
	}
}
