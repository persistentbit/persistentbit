...
public class Company{
	...
	public boolean equals(@Nullable Object o) {
		...
		if(adresBusNumber != null ? !adresBusNumber.equals(obj.adresBusNumber) : obj.adresBusNumber != null)
			return false;
	...
	public String toString() {
		return "Company[" +
			"id=" + id +
			", companyName=" + (companyName == null ? "null" : '\"' + UString
			.present(UString.escapeToJavaString(companyName), 32, "...") + '\"') +
			", adresStreet=" + (adresStreet == null ? "null" : '\"' + UString
			.present(UString.escapeToJavaString(adresStreet), 32, "...") + '\"') +
			", adresHouseNumber=" + adresHouseNumber +
			", adresBusNumber=" + (adresBusNumber == null ? "null" : '\"' + UString
			.present(UString.escapeToJavaString(adresBusNumber), 32, "...") + '\"') +
			", adresPostalcode=" + (adresPostalcode == null ? "null" : '\"' + UString
			.present(UString.escapeToJavaString(adresPostalcode), 32, "...") + '\"') +
			", adresCity=" + (adresCity == null ? "null" : '\"' + UString
	...
	public static Result<Company> buildExc(
		...
		return Result.noExceptions(() -> setter.apply(new Builder<>()))
			.mapExc(b -> new Company(b.id, b.companyName, b.adresStreet, b.adresHouseNumber, b.adresBusNumber, b.adresPostalcode, b.adresCity, b.adresCountry, b.ownerPersonId));
	}
}
