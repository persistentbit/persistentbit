...
public class AuthApp {
	...
	@DbColumnName("is_root")
	private  final	boolean	isRoot;
	@DbColumnName("is_active")
	private  final	boolean	isActive;
	@Nullable
	@DbColumnName("max_wrong_password_count")
	private  final	Integer	maxWrongPasswordCount;
	
	
	@Generated
	public AuthApp(long id, String name, String password, boolean isRoot, boolean isActive, @Nullable Integer maxWrongPasswordCount){
	...
	public  boolean	equals(@Nullable Object o){
		...
		if(maxWrongPasswordCount != null ? !maxWrongPasswordCount.equals(obj.maxWrongPasswordCount) : obj.maxWrongPasswordCount!= null) return false;
		return true;
	}
	@Generated
	@Override
	...
	@Generated
	@SuppressWarnings("unchecked")
	public  static AuthApp	build(ThrowingFunction<Builder<NOT,NOT,NOT,NOT,NOT>, Builder<SET,SET,SET,SET,SET>, Exception> setter){
		Builder b = setter.toNonChecked().apply(new Builder());
		return new AuthApp(b.id, b.name, b.password, b.isRoot, b.isActive, b.maxWrongPasswordCount);
	}
	@Generated
	@SuppressWarnings("unchecked")
	public  static Result<AuthApp>	buildExc(ThrowingFunction<Builder<NOT,NOT,NOT,NOT,NOT>, Builder<SET,SET,SET,SET,SET>,Exception> setter){
		return Result.noExceptions(() -> setter.apply(new Builder<>())).mapExc(b -> new AuthApp(b.id, b.name, b.password, b.isRoot, b.isActive, b.maxWrongPasswordCount));
	}
}
