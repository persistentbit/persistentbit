...
public class Addresses{
	...
	public boolean equals(@Nullable Object o) {
		...
		if(o instanceof Addresses == false) return false;
		Addresses obj = (Addresses) o;
	...
	public static Result<Addresses> buildExc(
		...
		return Result.noExceptions(() -> setter.apply(new Builder<>()))
			.mapExc(b -> new Addresses(b.addressId, b.streetLine1, b.streetLine2, b.postalCode, b.cityName, b.countryCode, b.district));
	}
}
