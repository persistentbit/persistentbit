...
public class GenData{
	...
	@Generated
	public GenData(int genDataId, int aInt, short aShort, long aLong, BigDecimal aNum, double aDouble, double aReal,
	...
	static public class Builder<_T1, _T2, _T3, _T4, _T5, _T6, _T7, _T8, _T9, _T10, _T11, _T12>{
		...
		public Builder<_T1, _T2, _T3, _T4, _T5, _T6, SET, _T8, _T9, _T10, _T11, _T12> setAReal(double aReal) {
			this.aReal = aReal;
	 ...
	 */
	@Generated
	public GenData withAReal(double aReal) {
		return new GenData(genDataId, aInt, aShort, aLong, aNum, aDouble, aReal, aBool, aDate, aTime, aTimestamp, aString);
	}
	...
	public boolean equals(@Nullable Object o) {
		...
		if(Double.compare(aReal, obj.aReal) != 0) return false;
	...
	public int hashCode() {
		...
		temp = Double.doubleToLongBits(this.aReal);
		result = 31 * result + (int) (temp ^ (temp >>> 32));
