package com.pbtest.h2.tables;

import com.pbtest.h2.expressions.EGenData;
import com.pbtest.h2.impl.typefactories.GenDataTypeFactory;
import com.pbtest.h2.inserts.InsertGenData;
...
public class TGenData extends AbstractTable<EGenData, GenData>{
	...
	private final TableName _tableName = new TableName("DEFAULT", "PBTEST", "GEN_DATA");
